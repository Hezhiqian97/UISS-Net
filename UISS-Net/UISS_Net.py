...
from nets.UISS_Net import UISS_Net as UISS_Net
...
class UISS_Net(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : 'weights/best_VGG_weights.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 8,
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            ...
            self.colors = [(0, 0, 0), (0, 0,255), (0, 255, 0), (0,255,255), (255,0, 0), (255,0,255),
    ...
    def generate(self, onnx=False):
        self.net = UISS_Net(num_classes = self.num_classes, backbone=self.backbone)
