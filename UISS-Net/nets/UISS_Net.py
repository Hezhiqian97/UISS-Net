...
class UISS_Net(nn.Module):
    def __init__(self, num_classes=21, pretrained=False, backbone='resnet50'):
        ...
        if backbone == "resnet50":
            ...
            self.ATU = ATU(pretrained=pretrained)
    ...
    def forward(self, inputs):
        ...
        if self.backbone == "resnet50":
            ...
            [feat11, feat22, feat33, feat44] = self.ATU.forward(inputs)
        ...
        #print(feat11.size(),feat22.size(),feat33.size(),feat44.size())
        ...
        # print(feat4.size(), feat3.size(), feat2.size(), feat1.size())
