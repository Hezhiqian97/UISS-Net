...
from nets.UISS_Net import UISS_Net as UISSNet
...
class UISS_Net(object):
    _defaults = {
        ...
        "model_path"    : 'logs/ep090-loss0.504-val_loss0.474.pth',
    ...
    def generate(self, onnx=False):
        self.net = UISSNet(num_classes = self.num_classes, backbone=self.backbone)
